...
const server = new Server({ name: serverConfig.name, version: serverConfig.version }, {
    ...serverConfig,
    capabilities: {
...
export async function handleListTools({ method, params }) {
    return { tools: allTools };
}
export async function handleCallTool({ method, params }) {
