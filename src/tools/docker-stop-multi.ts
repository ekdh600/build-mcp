...
export const dockerStopMultiSchema: DockerToolSchema = {
...
export async function dockerStopMulti(input: { containers: string[] }): Promise<{ content: { type: string; text: string }[] }> {
